        ...
        <ScrollAnimation animation="scale" delay={100}>
          <div className="glass rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 overflow-hidden mb-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                {techStack.map((tech) => (
                  <div key={tech.name} className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-foreground font-mono text-[11px] font-medium text-center leading-tight">{tech.name}</span>
                  ...
                  {techStack.map((tech, index) => (
                    ...
                    >
                      <div className="flex flex-col items-center justify-center h-full gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-6">
                        ...
                        />
                        <span className="text-foreground font-mono font-semibold text-xs sm:text-sm md:text-base text-center">{tech.name}</span>
            ...
            <div className="mt-10 sm:mt-12">
              <h4 className="text-sm sm:text-base md:text-lg font-bold text-center mb-4">AI Toolkit (Highlights)</h4>
